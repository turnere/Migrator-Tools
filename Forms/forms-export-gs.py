...
CSV_FILE = 'gs_form_id.csv'  # Path to the CSV file containing form IDs
OUTPUT_CSV = 'gs_form_fields.csv'  # Output CSV file for form fields
OUTPUT_JSON = 'gs_form_details.json'  # Output JSON file for full form details
